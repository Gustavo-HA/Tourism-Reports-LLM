...
\begin{frame}{Generación Estructurada}
	% El LLM no es el producto final. El LLM es solo un componente del sistema.Es \emph{un nodo} dentro de un
	...
	El LLM genera texto libre, pero necesitamos estructurarlo para
	garantizar una salida consistente y verificable. Sin esto, cada ejecución del LLM devuelve una salida libre, que puede no seguir el formato esperado de un reporte.
...
\begin{frame}{2. Recuperación: formulación}
...
\begin{frame}{4. Generación: el problema de la salida estructurada}
	...
	\textbf{Reto:} El LLM genera texto libre, pero necesitamos estructurarlo para
	garantizar una salida consistente y verificable. Sin esto, cada ejecución del LLM devuelve una salida libre, que puede no seguir el formato esperado de un reporte. Nuestro objetivo es poder definir un formato estructurado y que el LLM genere reportes consistentes.
