...
\begin{frame}{Introducción}
	El programa ``Pueblos Mágicos'' de México busca revalorizar localidades con atributos
	simbólicos e históricos, fomentando el turismo como motor de desarrollo económico local.

	\medskip
	\begin{columns}[T,onlytextwidth]
		\column{0.52\textwidth}
		La retroalimentación de los turistas es crucial para evaluar la efectividad y calidad
		de la experiencia ofrecida. Actualmente, el análisis de grandes volúmenes de opiniones
		(reseñas, comentarios en redes sociales) suele ser un proceso manual y lento.
		Este proyecto propone una solución automatizada para sintetizar y reportar estos datos
		de opinión.
...
\begin{frame}{Planteamiento del Problema}
	La gran cantidad de datos generados por los turistas en plataformas digitales constituye un
	recurso con potencial para la toma de decisiones en el sector turístico de los Pueblos Mágicos.

	\medskip
	\begin{itemize}
		\item El desafío radica en cómo transformar este \emph{big data} textual en reportes
		      concisos, coherentes y accionables de manera eficiente y escalable.
	\end{itemize}

	\bigskip
	\centering
	\begin{tikzpicture}[font=\normalsize, node distance=18mm]
		\node[draw=gray!50, fill=gray!10, rounded corners=4pt,
			minimum width=28mm, minimum height=20mm, align=center] (docs)
		{\footnotesize Reseñas\\\footnotesize masivas};
		\node[draw=accent, fill=accent!12, rounded corners=4pt,
			minimum width=28mm, minimum height=20mm, align=center,
			right=32mm of docs] (report)
		{\footnotesize Reporte\\\footnotesize accionable};
		\draw[-{Stealth[length=4mm]}, very thick, accent, line width=3pt]
		(docs) -- (report);
		\node[above=3mm, font=\scriptsize\itshape\color{accent}]
...
% =============================================================
\section{0. Visión global del pipeline}
% =============================================================
...
\begin{frame}{Pipeline general (cinco fases)}
	...
	\textbf{4.} Generación restringida \quad
