...
% --- Metadatos ---a
\title{Pipeline RAG para Inteligencia Turística}
\subtitle{Metodología técnica \\
\small{Reseñas RESTMEX de Pueblos Mágicos}}
...
\begin{frame}{1.3 El problema: k-NN exacto es prohibitivo}
	...
	estado del arte para coseno/euclidiana en dimensiones moderadas.
\end{frame}

\begin{frame}{1.3 HNSW}
	...
	\begin{itemize}
		...
		\item \textbf{Small-world graphs} (Kleinberg) $\to$ enlaces cortos
		      (vecinos cercanos) + enlaces largos (saltos), garantizando
		      diámetro logarítmico.
	\end{itemize}
...
\begin{frame}{2. Two-stage retrieval: recuperación y re-ranking}
	...
	\medskip
	\textbf{Idea clave.} Bi-encoder y cross-encoder son
	\textbf{complementarios}: el primero filtra eficientemente,
	el segundo discrimina con alta precisión sobre un conjunto pequeño.
\end{frame}
