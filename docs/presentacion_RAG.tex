...
\begin{frame}{Antecedentes \(\cdot\) Pueblos Mágicos}
	...
	\begin{columns}[T,onlytextwidth]
		...
		reseñas en \textbf{TripAdvisor, Google Maps o Booking} forman una
		\emph{voz del turista} densa, abundante y textualmente ruidosa.
...
\begin{frame}{Planteamiento del Problema}
	\textbf{Problema.}
	Cada Pueblo Mágico genera \textbf{miles de reseñas anuales}, dispersas en
	múltiples plataformas, polaridades y categorías de negocio. Las autoridades
	turísticas requieren convertir ese \emph{big data} textual en
	\textbf{reportes estratégicos accionables}, pero hoy el proceso es
	...
	\begin{itemize}\setlength\itemsep{3pt}
		...
		\item ¿Cómo separar la \textbf{atribución pública} (infraestructura,
		      señalética, servicios básicos, seguridad) de la
...
\begin{frame}{Planteamiento del Problema \(\cdot\) Relevancia}
	\begin{columns}[T,onlytextwidth]
		...
		\begin{itemize}\setlength\itemsep{3pt}
			...
			\item La voz del turista ya contiene la \emph{señal} para priorizar;
			      el cuello de botella es el \textbf{costo de análisis}, no
		...
		\begin{tikzpicture}[font=\footnotesize, node distance=14mm]
			\node[draw=gray!50, fill=gray!10, rounded corners=4pt,
				minimum width=26mm, minimum height=18mm, align=center] (docs)
			{Reseñas\\masivas};
			\node[draw=accent, fill=accent!12, rounded corners=4pt,
				minimum width=26mm, minimum height=18mm, align=center,
				right=20mm of docs] (report)
			{Reporte\\accionable};
			\draw[-{Stealth[length=4mm]}, very thick, accent, line width=3pt]
			(docs) -- (report);
			\node[above=2mm, font=\scriptsize\itshape\color{accent}]
